...
import com.example.adil.checkup.Notification.ReminderNotificationView;
...
//                Toast.makeText(context,MED_DETAILS,Toast.LENGTH_LONG).show();
        ...
        String neme=intent.getStringExtra("Med_name");
         ...
         med__id=intent.getIntExtra("Med_id",0);
        int m_id=intent.getIntExtra("M_id",0);
        Log.d("AlarmReceiver", String.valueOf(med__id));

        Toast.makeText(context,"Alarm wOrked"+neme,Toast.LENGTH_LONG).show();

        checkUp.getRingtone().play();
        Notification(context,"You have a Doctors Appointment Tomorrow",med__id,neme ,m_id);
    ...
    public void Notification(Context context, String message, int med_id,String name,int m_id) {
// Set Notification Title
        String strtitle = context.getString(R.string.notificationtitle);
// Open NotificationView Class on Notification Click
        Intent intent = new Intent(context, ReminderNotificationView.class);
...
// Create Notification using NotificationCompat.Builder
        NotificationCompat.Builder builder = new NotificationCompat.Builder(
                context)
// Set Icon
                .setSmallIcon(R.drawable.iconshospital)
// Set Ticker Message
                .setTicker(message)
// Set Title
